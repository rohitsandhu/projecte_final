...
Route::get('historial/{id}',[UserController::class,'historial'])->name('historial')->middleware(CheckLogged::class);
...
Route::get('profile/{id}',[UserController::class,'profile'])->name('profile')->middleware(CheckLogged::class);

Route::post('editarPerfil',[UserController::class,'editarPerfil'])->name('editarPerfil')->middleware(CheckLogged::class);
